...
namespace CLIPSNET
  ...
  /*
   ...
   void Environment::ByteLoader(
	   array<Byte>^ loadInBytes)
   {
	   array<Byte>^ ebLoadString = loadInBytes;
   ...
   void Environment::LoadFromResource(array<Byte> ^ resourceInBytes)
   {
	   char *oldName = m_Env->GetParsingFileName();

	   array<Byte>^ ebResourceName = resourceInBytes;
	   ...
	   this->ByteLoader(resourceInBytes);
